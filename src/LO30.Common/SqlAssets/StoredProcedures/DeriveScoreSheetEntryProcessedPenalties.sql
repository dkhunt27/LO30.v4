...
-- START comment this out when saving as stored proc
	...
	SET @StartingGameId = 3562;
	SET @EndingGameId = 3591;
...
*/
  ...
  SELECT
	...
	BEGIN
		...
		SET IDENTITY_INSERT ScoreSheetEntryProcessedPenalties ON
		...
		SET IDENTITY_INSERT ScoreSheetEntryProcessedPenalties OFF
