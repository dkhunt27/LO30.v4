...
*/
  ...
  SELECT
	...
	BEGIN
		...
		SET IDENTITY_INSERT ScoreSheetEntryProcessedSubs ON

		insert into ScoreSheetEntryProcessedSubs(ScoreSheetEntrySubId,
			SeasonId,
			TeamId,
			GameId,
			SubPlayerId,
		...
		SET IDENTITY_INSERT ScoreSheetEntryProcessedSubs OFF
	END
