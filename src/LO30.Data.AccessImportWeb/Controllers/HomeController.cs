...
namespace LO30.Data.AccessImportWeb.Controllers
{
  public class HomeController : Controller
  {
    LO30DbContext _context;
    public HomeController(LO30DbContext context)
    {
      _context = context;
    }
    ...
    public IActionResult Index()
    {
      ...
      using (_context)
      {
        ...
        var aImporter = new AccessImport.Importers.AccessImporter(logService.CreateLogger(), _context, !loadNewDataOnly, loadNewDataOnly);
