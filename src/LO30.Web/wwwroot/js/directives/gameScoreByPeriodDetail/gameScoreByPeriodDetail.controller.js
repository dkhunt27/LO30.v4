...
angular.module('lo30NgApp')
  ...
  [
    ...
    function ($log, $scope, externalLibService, apiService, screenSize) {
      ...
      var buildScoreSheetEntriesGoalsToDisplay = function (scoreSheetEntriesGoals) {

        var scoreSheetEntriesGoalsToDisplay = scoreSheetEntriesGoals.map(function (item, index) {
        ...
        return scoreSheetEntriesGoalsToDisplay;
      };

      var buildScoreSheetEntryPenaltiesToDisplay = function (scoreSheetEntryPenalties) {

        var scoreSheetEntryPenaltiesToDisplay = scoreSheetEntryPenalties.map(function (item, index) {
        ...
        return scoreSheetEntryPenaltiesToDisplay;
      };

      var buildGoalieStatGamesToDisplay = function (goalieStatGames) {

        var goalieStatGamesToDisplay = goalieStatGames.map(function (item, index) {
          ...
          if (item.wins === 1) {
            ...
            $scope.local.goalieStatGameWinner.push(item);

          } else {

            $scope.local.goalieStatGameLoser.push(item);
        ...
        return goalieStatGamesToDisplay;
      };
      ...
      $scope.fetchScoreSheetEntryGoals = function (gameId) {
        ...
        apiService.scoreSheetEntryProcessedGoals.listForGameId(gameId).then(function (fulfilled) {
          ...
          $scope.local.scoreSheetEntriesGoals = buildScoreSheetEntriesGoalsToDisplay(fulfilled);
      ...
      $scope.fetchScoreSheetEntryPenalties = function (gameId) {
        ...
        apiService.scoreSheetEntryProcessedPenalties.listForGameId(gameId).then(function (fulfilled) {
          ...
          $scope.local.scoreSheetEntryPenalties = buildScoreSheetEntryPenaltiesToDisplay(fulfilled);
      ...
      $scope.fetchGoalieStatGames = function (gameId) {
        ...
        apiService.goalieStatGames.listForGameId(gameId).then(function (fulfilled) {
          ...
          $scope.local.goalieStatGames = buildGoalieStatGamesToDisplay(fulfilled);
