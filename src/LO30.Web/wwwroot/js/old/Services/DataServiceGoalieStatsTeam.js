...
lo30NgApp.factory("dataServiceGoalieStatsTeam",
  [
    "constApisUrl",
    "$resource",
    function (constApisUrl, $resource) {
      ...
      var resourceQuery = $resource(constApisUrl + '/goalieStatsTeam/:playerId/:seasonId', { playerId: '@playerId', seasonId: '@seasonId' });

      // return single item
      var resourceGet = $resource(constApisUrl + '/goalieStatTeam/:playerId/:teamId', { playerId: '@playerId', teamId: '@teamId' });
